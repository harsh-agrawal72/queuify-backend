    ...
    try {
        const result = await pool.query(
             `SELECT a.*, 
                     ...
                     o.name as org_name, o.email as org_contact_email, o.phone as org_contact_phone,
    ...
    const result = await pool.query(
        `WITH QueueRanks AS (
         ...
         SELECT a.*, 
                ...
                o.name as org_name, COALESCE(p.address, o.address) as org_address, p.city as org_city, p.state as org_state, p.pincode as org_pincode, o.phone as org_contact_phone, o.email as org_contact_email, logo.image_url as org_logo_url,
                sl.start_time, sl.end_time, a.reschedule_count,
                a.proposed_slot_id, a.reschedule_status, a.reschedule_reason, a.is_priority,
                psl.start_time as proposed_start_time, psl.end_time as proposed_end_time,
